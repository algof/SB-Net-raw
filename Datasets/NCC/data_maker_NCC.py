...
for df_orig in all_dfs_to_transform:
    ...
    # --- Use NCC protocol list ---
    protocol_cols_from_target = [
        'arp', 'esp', 'icmp', 'igmp', 'ipv6', 'ipv6-icmp', 'ipx/spx', 'llc',
        'pim', 'rarp', 'rtcp', 'rtp', 'tcp', 'udp', 'udt', 'unas', 'ipnip' # Added ipnip based on target
    ]
    # Adjust if NCC has different protocols (e.g., no gre/rsvp)
    protocol_cols_from_target = [
        'arp', 'esp', 'icmp', 'igmp', 'ipv6', 'ipv6-icmp', 'ipx/spx', 'llc',
        'pim', 'rarp', 'rtcp', 'rtp', 'tcp', 'udp', 'udt', 'unas', 'ipnip'
        # Example without gre/rsvp if they are NCC-2 specific
        # 'arp', 'esp', 'icmp', 'igmp', 'ipv6', 'ipv6-icmp', 'ipx/spx', 'llc',
        # 'pim', 'rarp', 'rtcp', 'rtp', 'tcp', 'udp', 'udt', 'unas', 'ipnip'
    ]
